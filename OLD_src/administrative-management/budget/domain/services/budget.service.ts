...
import { BudgetVehiclePartService } from '../../../budget-vehicle-part/domain/services/budget-vehicle-part.service';
import { BaseService } from '../../../../shared/domain/services/base-service.service';
import { UpdateBudgetVehiclePartDto } from '../../../budget-vehicle-part/presentation/dto/update-budget-vehicle-part.dto';
import { RemoveBudgetVehiclePartDto } from '../../../budget-vehicle-part/presentation/dto/remove-budget-vehicle-part.dto';
import { CreateBudgetVehiclePartDto } from '../../../budget-vehicle-part/presentation/dto/create-budget-vehicle-part.dto';
...
import { ServiceOrderStatus } from '../../../service-order/domain/enum/service-order-status.enum';
import { ServiceOrderHistoryService } from '../../../service-order-history/domain/services/service-order-history.service';
...
import { BudgetVehicleServicesService } from '../../../budget-vehicle-services/domain/services/budget-vehicle-services.service';
